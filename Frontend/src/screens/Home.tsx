...
const Home = () => {
  ...
  return (
    <div id="home">
      <img src="/assets/bg.webp" alt="background" className="w-full h-screen object-cover " />
      <div className="w-full h-screen absolute top-0 left-0 bg-white/30">
        <div className="max-w-[1000px] items-center justify-center m-auto h-full w-full flex flex-col lg:items-start ">
          ...
          <h2 className="flex sm:text-4xl text-2xl font-bold pt-4 text-gray-800">
            <TypeAnimation key={i18n.language} sequence={[t("status1"), 2000, t("status2"), 2000]} wrapper="span" speed={50} style={{ fontSize: "1em", paddingLeft: "5px" }} repeat={Infinity} />
          </h2>
